...
本项目在 [CC BY-NC 4.0 协议](http://creativecommons.org/licenses/by-nc/4.0/)下发布。
您可以在有恰当署名、**非商业用途**、没有附加限制的前提下，自由地复制、传播本作品，或是在本作品的基础上修改、再创作。
请参阅 [LICENSE 文件](./LICENSE) 及其[中文说明](LICENSE.zh.md)。
